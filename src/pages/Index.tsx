...
//               </Link>
//                <Link to="/login">
//                 <Button variant="outline">L O G I N</Button>
//               </Link>
//             </div>
//           </div>
//         </div>
  ...
  const features = [
    {
      ...
      title: "QR/Barcode Scanning",
      description:
        "Instantly scan products to retrieve compliance information and verify authenticity.",
      color: "text-primary",
    },
    {
      icon: Shield,
      title: "AI Compliance Checking",
      description:
        "Automated verification of packaging declarations including MRP, manufacturer info, and quantities.",
      color: "text-success",
    },
    {
      icon: FileText,
      title: "Complaint Management",
      description:
        "Streamlined system for filing, tracking, and resolving product compliance complaints.",
      color: "text-warning",
    },
    {
      icon: BarChart3,
      title: "Analytics & Reporting",
      description:
        "Comprehensive dashboards and reports for monitoring compliance trends and performance.",
      color: "text-error",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
          Protect consumers and ensure e-commerce compliance with our
          AI-powered solution that automatically checks product declarations,
          handles complaints, and provides real-time alerts.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/dashboard">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to ensure product compliance and manage
              consumer complaints in one integrated platform.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-primary/5 text-center">
        <AlertTriangle className="h-12 sm:h-16 w-12 sm:w-16 text-warning mx-auto mb-6" />
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">
          Protect Your Customers Today
        </h2>
        <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Join thousands of e-commerce platforms using our compliance solution
          to ensure product safety and build consumer trust.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/dashboard">
            <Button size="lg" className="h-12 px-8">
          ...
          <Link to="/complaints">
            <Button
              size="lg"
              variant="outline"
              className="h-12 px-8 border-input"
            >
              View Complaints
            </Button>
          </Link>
      ...
      <footer className="border-t py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <p className="text-muted-foreground text-center md:text-right">
            &copy; {new Date().getFullYear()} ComplianceCheck. All Rights
            Reserved.
          </p>
        </div>
      </footer>
